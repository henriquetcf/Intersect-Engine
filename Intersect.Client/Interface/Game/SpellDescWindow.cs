...
namespace Intersect.Client.Interface.Game
{
    ...
    public class SpellDescWindow
    {
        ...
        public SpellDescWindow(Guid spellId, int x, int y, bool centerHorizontally = false)
        {
            ...
            spellType.Text = Strings.SpellDescription.SpellTypes[(int) spell.SpellType];
            ...
            {
                spellDesc.AddText(
                    Strings.SpellDescription.Description.ToString(spell.Description), spellDesc.RenderColor,
            ...
            if (spell.SpellType == (int) SpellTypes.CombatSpell)
            {
                if (spell.Combat.TargetType == SpellTargetTypes.Projectile)
                {
                    ...
                    spellType.Text = Strings.SpellDescription.TargetTypes[(int) spell.Combat.TargetType]
            ...
            {
                spellStats.AddText(
                    Strings.SpellDescription.HitRadius.ToString(spell.Combat.HitRadius), spellStats.RenderColor,
            ...
            if (spell.CastDuration > 0)
            {
                ...
                spellStats.AddText(
                    Strings.SpellDescription.CastTime.ToString(castDuration), spellStats.RenderColor,
                    spellStatsText.CurAlignments.Count > 0 ? spellStatsText.CurAlignments[0] : Alignments.Left,
                    spellStatsText.Font
                );
            ...
            if (spell.CooldownDuration > 0)
            {
                var cdr = /*1 -*/ spell.CooldownDuration /*/ 100*/;
                //var cdr = 1 - Globals.Me.GetCooldownReduction() / 100;
                var cd = (float) (spell.CooldownDuration * cdr) / 1000f;
                spellStats.AddText(
                    Strings.SpellDescription.Cooldown.ToString(cd), spellStats.RenderColor,
                    spellStatsText.CurAlignments.Count > 0 ? spellStatsText.CurAlignments[0] : Alignments.Left,
                    spellStatsText.Font
                );
            ...
            {
                spellStats.AddText(
                    /*Strings.SpellDescription.prereqs*/
                    "Requisitos: ", spellStats.RenderColor,
                    spellStatsText.CurAlignments.Count > 0 ? spellStatsText.CurAlignments[0] : Alignments.Left,
                    spellStatsText.Font
                );
                ...
                {
                    spellStats.AddText(
                        Strings.SpellDescription.VitalCosts[(int) Vitals.Health]
                ...
                {
                    spellStats.AddText(
                        Strings.SpellDescription.VitalCosts[(int) Vitals.Mana].ToString(spell.VitalCost[(int) Vitals.Mana]),
            ...
            var stats = "";
            if (spell.SpellType == (int) SpellTypes.CombatSpell ||
                spell.SpellType == SpellTypes.Passive)
            {
                stats = Strings.SpellDescription.Effect;
                spellStats.AddText(
                ...
                {
                    spellStats.AddText(
                        Strings.SpellDescription.effectlist[(int) spell.Combat.Effect], spellStats.RenderColor,
                        spellStatsText.CurAlignments.Count > 0 ? spellStatsText.CurAlignments[0] : Alignments.Left,
                        spellStatsText.Font
                    );
                ...
                for (var i = 0; i < (int) Vitals.VitalCount; i++)
                {
                    ...
                    var vitalSymbol = vitalDiff < 0 ? Strings.SpellDescription.addsymbol : Strings.SpellDescription.removesymbol;
                    if (spell.Combat.Effect == StatusTypes.Shield)
                    {
                        stats = Strings.SpellDescription.ShieldSize.ToString(Math.Abs(vitalDiff));
                    }
                    else
                    {
                        stats = Strings.SpellDescription.VitalDamage[i].ToString(vitalSymbol, Math.Abs(vitalDiff));
                    }
                ...
                if (spell.Combat.Duration > 0 || spell.SpellType == SpellTypes.Passive)
                {
                    for (var i = 0; i < (int)Stats.StatCount; i++)
                    {
                        ...
                        {
                            spellStats.AddText(
                                Strings.SpellDescription.Stats[i]
                                    .ToString(
                                        (spell.Combat.StatDiff[i] > 0
                                            ? Strings.SpellDescription.addsymbol.ToString()
                                            : Strings.SpellDescription.removesymbol.ToString()) +
                        ...
                        } else if (spell.Combat.StatDiff[i] != 0 && spell.Combat.PercentageStatDiff[i] != 0)
                        {
                            spellStats.AddText(
                                Strings.SpellDescription.Stats[i]
                                    .ToString(
                                        (spell.Combat.StatDiff[i] > 0
                                            ...
                                            : Strings.SpellDescription.removesymbol.ToString()) +
                                        Math.Abs(spell.Combat.StatDiff[i]) + " (" +
                                        (spell.Combat.PercentageStatDiff[i] > 0
                                            ? Strings.SpellDescription.addsymbol.ToString()
                                            : Strings.SpellDescription.removesymbol.ToString()) +
                                        Math.Abs(spell.Combat.PercentageStatDiff[i]) + "%)"
                                    ), spellStats.RenderColor,
                                spellStatsText.CurAlignments.Count > 0
                                    ? spellStatsText.CurAlignments[0]
                                    : Alignments.Left, spellStatsText.Font
                    ...
                    if (spell.SpellType != SpellTypes.Passive)
                    {
                        ...
                        spellStats.AddText(
                            Strings.SpellDescription.Duration.ToString(duration), spellStats.RenderColor,
                            spellStatsText.CurAlignments.Count > 0 ? spellStatsText.CurAlignments[0] : Alignments.Left,
                            spellStatsText.Font
                        );
